...
function ForsaleBoardPost (){
    const params = new URLSearchParams(window.location.search);
    const [postID, setPostID] = useState(params.get("postID"));
    const [endpoint, setEndpoint] = useState("http://localhost:3004/FSBoards?postID=".concat(params.get("postID")));
...
export default ForsaleBoardPost;